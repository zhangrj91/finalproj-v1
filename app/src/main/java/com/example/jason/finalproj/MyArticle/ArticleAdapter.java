...
public class ArticleAdapter extends RecyclerView.Adapter<ArticleAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            mshare = (ImageView) itemView.findViewById(R.id.article_item_share);
    ...
    public interface OnItemClickListener {
        ...
        void ShareOnClick(View view, int position);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        //分享
        ImageView share = holder.mshare;
        share.setImageBitmap(mImage.get(position).get("share"));
        //收藏
        ...
        if(mOnItemClickListener != null) {
            ...
            holder.mshare.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    mOnItemClickListener.ShareOnClick(holder.itemView, holder.getLayoutPosition());
                }
            });
