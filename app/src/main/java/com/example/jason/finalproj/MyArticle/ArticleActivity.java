...
public class ArticleActivity extends AppCompatActivity {
    ...
    private void init(){
        ...
        range=(TextView)findViewById(R.id.range1);
                ...
                switch (msg.what){
                    case 123:
                        if(mArticle!=null){
                            ...
                            if(mArticle.getType()==1) type.setText("比赛");
                            else if(mArticle.getType()==2)type.setText("项目");
                            ...
                            range.setText(rag);
                            if(mArticle.getState()==1) state.setText("招募中");
                            else state.setText("招募已结束");
