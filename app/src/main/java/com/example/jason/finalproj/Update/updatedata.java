            ...
            public void run() {
                try {
                    ...
                    if (db.search(name, con) && db.getUidByName(name, con) != u_id) {
                        ...
                        Users myuser = db.getUserById(u_id, con);
                        db.updateUserByName(myuser.getName(), name, sex, githubname, description, email, con);
                        db.updateUphotoByName(myuser.getName(), bitmap, con);
